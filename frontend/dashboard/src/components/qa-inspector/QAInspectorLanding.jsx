...
export default function QAInspectorLanding() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '2.5rem', marginBottom: '1.5rem', color: '#ff6b6b' }}>
          Enter QA inspector dashboard
        </h1>
        ...
        <button
          ...
          onMouseOver={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(255, 107, 107, 0.6)'; }}
          onMouseOut={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 15px rgba(255, 107, 107, 0.4)'; }}
        >
          Proceed
        </button>
      </div>
