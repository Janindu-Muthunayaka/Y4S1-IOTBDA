  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: '2.5rem', marginBottom: '1.5rem', color: 'var(--accent-cyan)' }}>
          Enter driver dashboard
        </h1>
        <p style={{ marginBottom: '2.5rem', fontSize: '1.1rem', color: 'var(--text-secondary)' }}>
          Access real-time navigation, trip status, and cargo condition monitoring.
        </p>
        <button
          ...
          onMouseOver={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(0, 240, 255, 0.6)'; }}
          onMouseOut={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 15px rgba(0, 240, 255, 0.4)'; }}
        >
          Proceed
        </button>
      </div>
