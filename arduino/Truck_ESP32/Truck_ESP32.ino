...
#define SHOCK_LED_PIN  18//------------------------------------------------WAS 18
...
float REAL_TEMP_MAX  = 32.0;

float SIM_TEMP_MIN   = -20.0;

float SIM_TEMP_MAX   = -18.0;

float SAFE_TEMP_LOW  = -20.0;

float SAFE_TEMP_HIGH =  -18.0;//----------------------------------------------------WAS 4
